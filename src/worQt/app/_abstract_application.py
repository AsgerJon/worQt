...
the return code, the splash screen and the main window. The window *type* is
app-specific, so a concrete subclass declares it with '__window_class__';
...
'self.app.window' reaches these from anywhere in the object graph.
"""
#  Apache-2.0 license
