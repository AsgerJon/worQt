...
class PaintedWidget(AbstractWidget):
  ...
  # --- Box Model Variables
  __fallback_margins_dims__ = InSets(2, 2, 2, 2, frozen=True)
  __fallback_borders_dims__ = InSets(1, 1, 1, 1, frozen=True)
  __fallback_paddings_dims__ = InSets(2, 2, 2, 2, frozen=True)
